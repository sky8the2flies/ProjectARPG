...
namespace sky8the2flies.Editor
{
    /// <summary>
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "Project ARPG/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "Project ARPG/Don't Load Bootstrap Scene On Play";
